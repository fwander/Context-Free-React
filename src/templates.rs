...
{% endfor %}
    ...
    tera.add_raw_template("components.tsx",std::str::from_utf8(include_bytes!("templates/components.tsx")).unwrap_or("")).unwrap();
    //tera.add_raw_template("ast_file",std::str::from_utf8(include_bytes!("templates/ast_file")).unwrap_or("")).unwrap();
    ...
    tera.add_raw_template("focus.ts",std::str::from_utf8(include_bytes!("templates/focus.ts")).unwrap_or("")).unwrap();
    tera.add_raw_template("lib.css",std::str::from_utf8(include_bytes!("templates/lib.css")).unwrap_or("")).unwrap();
    tera.add_raw_template("select.css",std::str::from_utf8(include_bytes!("templates/select.css")).unwrap_or("")).unwrap();
    tera.add_raw_template("Select.tsx",std::str::from_utf8(include_bytes!("templates/Select.tsx")).unwrap_or("")).unwrap();
    tera.add_raw_template("VariableList.tsx",std::str::from_utf8(include_bytes!("templates/VariableList.tsx")).unwrap_or("")).unwrap();
    tera.add_raw_template("Terminal.tsx",std::str::from_utf8(include_bytes!("templates/Terminal.tsx")).unwrap_or("")).unwrap();
    tera.add_raw_template("Regex.tsx",std::str::from_utf8(include_bytes!("templates/Regex.tsx")).unwrap_or("")).unwrap();
    tera.add_raw_template("lib.tsx",std::str::from_utf8(include_bytes!("templates/lib.tsx")).unwrap_or("")).unwrap();
...
fn expression_to_component(expression: &ebnf::Expression, description: &config::NodeDescription) -> String {
